import type { FilterCondition, AppointmentFilterFields } from './types'
import {
  buildDateFilter,
  buildStringFilter,
  buildNumberFilter,
 ...
 */
const FIELD_TYPE_MAP: Record<keyof AppointmentFilterFields, AppointmentFilterFields[keyof AppointmentFilterFields]['type']> = {
  // Date fields
  createdAt: 'date',
  updatedAt: 'date',
  ...
  for (const filter of filters) {
    ...
    try {
      ...
      switch (fieldType) {
        ...
        default:
          console.warn(`Unsupported field type: ${fieldType} for field: ${field}`)
      }
