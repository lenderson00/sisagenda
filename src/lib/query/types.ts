 ...
 */
export type FieldType<T extends AppointmentFilterFieldName> =
  AppointmentFilterFields[T]["type"];

/**
 * Type for getting the operators for a specific field
 */
export type FieldOperators<T extends AppointmentFilterFieldName> =
  AppointmentFilterFields[T]["operators"][number];
