...
export function AppointmentActionsDropdown({
  ...
  // Create a compatible appointment object with all required properties
  const compatibleAppointment = {
    items: [], // Add missing items property
    attachments: [], // Add missing attachments property
    activities: [], // Add missing activities property
    ...appointment,
  };
